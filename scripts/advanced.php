...
?>
    ...
    <form id="advancedform" action="" method="GET">
      ...
      <input name="max_files_species" type="number" style="width:6em;" min="0" step="1" value="<?php print($newconfig['MAX_FILES_SPECIES']);?>"/><br>
      If different than 0 (keep all), defines the maximum number of files to be kept for each species, with priority give to files with highest confidence.<br>
...
?>
      ...
      Do NOT use special characters. Accepted characters: [A-Z0-9a-z]<br>
      This password will protect your "Tools" page and "Live Audio" stream.<br>
      </td></tr></table><br>
      <table class="settingstable"><tr><td>
      <h2>Custom URL</h2>
      ...
      When you update this URL, the web server will reload, so be sure to wait at least 30 seconds and then go to your new URL.</p>
      The BirdNET-Pi URL is how the main page will be reached. If you want your installation to respond to an IP address, place that here, but be sure to indicate "<i>http://</i>".<br>Example for IP: <i>http://192.168.0.109</i><br>Example if you own your own domain: <i>https://virginia.birdnetpi.com</i><br>
      </td></tr></table><br>
      <table class="settingstable"><tr><td>
      <h2>Options</h2>
      ...
      This allows you to quiet the display of how many commits your installation is behind by relative to the Github repo. This number appears next to "Tools" when you're 50 or more commits behind.<br><br>
      ...
      This allows you to remove the axes and labels of the spectrograms that are generated by Sox for each detection for a cleaner appearance.<br>
      </td></tr></table><br>
